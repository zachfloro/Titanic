...
rf = RandomForestClassifier(random_state=13, criterion='gini', max_samples=.25)
...
clf = GridSearchCV(rf, parameters, cv=3) # perform gridsearch and cross validation
...
sub.to_csv('./Predictions/rf_submission.csv', index=False)
